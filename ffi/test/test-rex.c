...
int main() {
  ...
  assert(strcmp(expr, "Matcher { data: \"asdf\", expr(\"asdf\"): Expr::Concatenation { components: [Expr::SingleLiteral(SingleLiteral('a')), Expr::SingleLiteral(SingleLiteral('s')), Expr::SingleLiteral(SingleLiteral('d')), Expr::SingleLiteral(SingleLiteral('f'))] } }") == 0);
